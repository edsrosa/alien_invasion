...
class Bullet(Sprite):
    ...
    def __init__(self, ai_settings, screen, ship):
        ...
        super().__init__()
        self.screen = screen
        self.rect = pygame.Rect(0, 0, ai_settings.bullet_width, ai_settings.bullet_height)  # Cria um retângulo para o
        # projétil em (0, 0) e, em seguida, define a posição correta
    ...
    def update(self):
        ...
        self.y -= self.speed_factor  # Atualiza a posição decimal do projétil
        self.rect.y = self.y
